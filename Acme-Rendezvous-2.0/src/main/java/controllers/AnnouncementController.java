...
public class AnnouncementController extends AbstractController {
	...
	//	public ModelAndView create(@Valid final Announcement announcement, final BindingResult binding) {
	//		ModelAndView res;
	//
