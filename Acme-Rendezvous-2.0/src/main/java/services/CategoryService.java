...
public class CategoryService {
	...
	public CategoryForm construct(final Category category) {

		final CategoryForm res = new CategoryForm();
	...
	public Category reconstruct(final CategoryForm categoryForm, final BindingResult binding) {
