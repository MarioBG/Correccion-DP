...
<fieldset>
<b><spring:message  code="dashboard.findTrips10MoreApplications"/></b>
<display:table name="findTrips10MoreApplications" id="row" pagesize="5" class="displaytag" requestURI="dashboard/admin/list.do">
	...
	<display:column property="startDateTrip" title="${startDateHeader}" format="${formatDate}" sortable="true" />
	
	<spring:message var="endDateHeader" code="trip.endDate"/>
	<display:column property="endDateTrip" title="${endDateHeader}" format="${formatDate}" sortable="true" />
...
<fieldset>
<b><spring:message  code="dashboard.findLegalTextOrderByReferenced"/></b>
<display:table name="findLegalTextOrderByReferenced" id="row" pagesize="10" class="displaytag" requestURI="dashboard/admin/list.do">
	<spring:message var="titleHeader" code="trip.title"/>
...
<fieldset>
	<div>
		<b><spring:message code="dashboard.minMaxAvgDevNotesPerTrip" /></b>
		<br /> 
		<h4><jstl:out value=" MIN: "/><jstl:out value="${minMaxAvgDevNotesPerTrip[0][0]}"/> <br /></h4>
		<h4><jstl:out value=" MAX: "/><jstl:out value="${minMaxAvgDevNotesPerTrip[0][1]}"/> <br /> </h4>
		<h4><jstl:out value=" AVG: "/><jstl:out value="${minMaxAvgDevNotesPerTrip[0][2]}"/> <br /></h4>
		<h4><jstl:out value=" STDDEV: "/><jstl:out value="${minMaxAvgDevNotesPerTrip[0][3]}"/> <br /></h4>
	</div>
</fieldset>
<br/>
...
<fieldset>
	<div>
		<b><spring:message code="dashboard.minMaxAvgDevAuditRecordPerTrip" /></b>
		<br /> 
		<h4><jstl:out value=" MIN: "/><jstl:out value="${minMaxAvgDevAuditRecordPerTrip[0][0]}"/> <br /></h4>
		<h4><jstl:out value=" MAX: "/><jstl:out value="${minMaxAvgDevAuditRecordPerTrip[0][1]}"/> <br /> </h4>
		<h4><jstl:out value=" AVG: "/><jstl:out value="${minMaxAvgDevAuditRecordPerTrip[0][2]}"/> <br /></h4>
		<h4><jstl:out value=" STDDEV: "/><jstl:out value="${minMaxAvgDevAuditRecordPerTrip[0][3]}"/> <br /></h4>
	</div>
</fieldset>
<br/>
...
<fieldset>
	<div>
		<b><spring:message code="dashboard.ratioOfTripsWithAnyAuditRecord" /></b>
		<br /> 
		<h4><jstl:out value=" RATIO: "/><jstl:out value="${ratioOfTripsWithAnyAuditRecord}"/> <br /></h4>
	</div>
</fieldset>
<br/>
...
<fieldset>
	<div>
		<b><spring:message code="dashboard.ratioRangersWithCurriculum" /></b>
		<br /> 
		<h4><jstl:out value=" RATIO: "/><jstl:out value="${ratioRangersWithCurriculum}"/> <br /></h4>
	</div>
</fieldset>
<br/>
...
<fieldset>
	<div>
		<b><spring:message code="dashboard.ratioRangersCurriculumWithEndorserRecords" /></b>
		<br /> 
		<h4><jstl:out value=" RATIO: "/><jstl:out value="${ratioRangersCurriculumWithEndorserRecords}"/> <br /></h4>
	</div>
</fieldset>
<br/>
...
<fieldset>
	<div>
		<b><spring:message code="dashboard.ratioManagersSuspicious" /></b>
		<br /> 
		<h4><jstl:out value=" RATIO: "/><jstl:out value="${ratioManagersSuspicious}"/> <br /></h4>
	</div>
</fieldset>
<br/>
...
<fieldset>
	<div>
		<b><spring:message code="dashboard.ratioRangersSuspicious" /></b>
		<br /> 
		<h4><jstl:out value=" RATIO: "/><jstl:out value="${ratioRangersSuspicious}"/> <br /></h4>
	</div>
</fieldset>
<br/>

<input type="button" name="cancel" value="<spring:message code="contact.cancel" />" onclick="javascript: relativeRedir('welcome/index.do');" />
