...
<display:table name="trips" id="row" pagesize="5" class="displaytag" requestURI="finder/explorer/edit.do" >
	...
	<display:column property="startDateTrip" title="${startDateHeader}" sortable="true" format="${formatDate}"/>
	
	<spring:message var="formatDate" code="event.format.date"/>
	<spring:message var="endDateHeader" code="trip.endDate"/>
	<display:column property="endDateTrip" title="${endDateHeader}" sortable="true" format="${formatDate}"/>
