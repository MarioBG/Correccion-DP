...
public class TripService {
	...
	public Collection<Trip> findCanWriteStoryByApplicantId(final int explorerId) {
		final Collection<Trip> result = this.tripRepository.findCanWriteStoryByApplicantId(explorerId);
		return result;
	}
	...
	public Collection<Trip> findByDateBeforeStartDateTrip(final Date moment) {
		Assert.notNull(moment);
		final Collection<Trip> result = this.tripRepository.findByDateBeforeStartDateTrip(moment);
		return result;
	}
