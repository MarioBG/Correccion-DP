...
<form:form action="${actionURI}" modelAttribute="manager" onsubmit="return validateForm()">
	...
	<jstl:if test="${manager.id == 0}">
		...
		<b><form:label path="userAccount.username"><spring:message code="manager.userAccount.username" /></form:label>:&nbsp;</b>
		<form:input path="userAccount.username" />
		<form:errors path="userAccount.username" cssClass="error"  />
		<br />
		
		<b><form:label path="userAccount.password"><spring:message code="manager.userAccount.password" /></form:label>:&nbsp;</b>
		<form:password path="userAccount.password" />
		<form:errors path="userAccount.password" cssClass="error"  />
		<br />
	</jstl:if>
	
	<b><form:label path="name"><spring:message code="manager.name"/></form:label>:&nbsp;</b>
	<form:input path="name"/>
	<form:errors path="name" cssClass="error"/>
	<br/>
	
	<b><form:label path="surname"><spring:message code="manager.surname"/></form:label>:&nbsp;</b>
	<form:input path="surname"/>
	<form:errors path="surname" cssClass="error"/>
	<br/>
	
	<b><form:label path="email"><spring:message code="manager.email"/></form:label>:&nbsp;</b>
	<form:input path="email"/>
	<form:errors path="email" cssClass="error"/>
	<br/>
	
	<b><form:label path="address"><spring:message code="manager.address"/></form:label>:&nbsp;</b>
